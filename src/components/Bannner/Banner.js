...
const Banner = () => {
    ...
    const sliders = ['https://i.ibb.co/wy9q9B4/img1.webp','https://i.ibb.co/9qhqd3b/img2.webp','https://i.ibb.co/Yp1c0dc/img3.webp"','https://i.ibb.co/j3qX4Vw/img4.webp'];
    ...
    return (
            ...
            <div className="max-w-screen-2xl mx-auto h-[240px] md:h-[470px] lg:h-[700px] flex flex-col lg:flex-row items-center overflow-hidden gap-5 lg:gap-10 px-10">
